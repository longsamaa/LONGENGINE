...
#include "Long/Platform/OpenGl/imgui_impl_opengl3.h"
...
namespace Long
{
	...
	void ImGuiLayer::OnUpdate()
	{
		...
		io.DeltaTime = ImGuiLayer::m_Time > 0.0 ? (time - ImGuiLayer::m_Time) : (1.0f / 60.0f);
		ImGuiLayer::m_Time = time;
	...
	void ImGuiLayer::OnEvent(Long::Event& event)
	{
		Long::EventDispatcher dispatcher(event); 
		//Mouse Event
